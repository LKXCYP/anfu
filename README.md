<html lang="zh-CN">
  <head>
    ...
    <style>
      ...
      #centered-div {
          ...
          margin: 0 auto; /* 将外边距设置为自动，使div居中 */
  ...
  <body>
    <div id="centered-div">
      <img src="images/安复logo.png" alt="安复logo" title="至诚学院logo和安复logo" width="400"/>
      <!-- logo栏 -->
    ...
    <h2>公司地址</h2>
    <p>
      福建省福州市鼓楼区洪山镇福三路20号（原工业路东侧,福三路北侧洪山园地块）华润万象城（一区）（一期）S5#楼12层05办公
    </p>
    <p>
      <a href="https://www.zhipin.com/companys/25d93bf441972c191Hx9296-GVQ~.html" target="_blank">详细信息</a>
    </p>
    <!-- 跳转到外部链接（boss直聘）的简介 -->
    <h2>
      主营项目
    ...
    <h2 id="about">关于我们</h2>
    <p>
      &nbsp&nbsp福州安复安全咨询服务有限公司是一家专注于安全管理领域的高新技术企业，公司成立于2018年，总部位于福建省福州市鼓楼区洪山镇福三路20号（原工业路东侧,福三路北侧洪山园地块）华润万象城（一区）（一期）S5#楼12层05办公。
    </p>
    <p>
      &nbsp&nbsp公司拥有一支由国内外知名高校和科研院所的专家学者组成的技术团队，具有丰富的安全管理经验和深厚的技术积累，致力于为客户提供专业、高效的安全管理解决方案。
    </p>
    <p>
      &nbsp&nbsp公司主营业务包括信息化安全、消防安全、安全生产、安全培训等多个领域，涵盖了政府、企事业单位、学校、医院等多个行业，为客户提供了全方位的安全管理服务。
    </p>
